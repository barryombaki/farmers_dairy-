...
<form action='' method='POST' class="form-horizontal"> 
    ...
    <div class="control-group">
        <label class="control-label" for="rate"> Rate ( KSH/litre)</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="add..." name='rate' id='r_kg' value='<?php echo stripslashes($row['rate']) ?>'/> 
    </div>
