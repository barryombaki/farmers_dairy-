...
<form action='' method='POST' class="form-horizontal" name="delivery"> 
    ...
    <div class="control-group">
        <label class="control-label" for="r_ltr"> Milk in Litres:</label >
        <div class="controls">
    ...
    <div class="control-group">
    <label class="control-label" for="r_ltr"> rate per kg:</label >
    <div class="controls">
                                ...
                                <select class="form-control" name="rate"  >
                                    ...
                                    <?php
                                        $result = mysqli_query($conn,"SELECT rate FROM `settings_rates`") or trigger_error(mysqli_error($conn)); 
                                        $cnt=1;
